...
@Pipe({ name: 'ngxHelperJalali' })
export class NgxHelperJalaliPipe implements PipeTransform {
    constructor(@Inject('NGX_HELPER_TIMEZONE') public readonly timezone: string) {}
