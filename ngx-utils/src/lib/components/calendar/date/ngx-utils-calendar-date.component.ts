...
@Component({
    templateUrl: './ngx-utils-calendar-date.component.html',
    styleUrls: ['./ngx-utils-calendar-date.component.scss'],
})
export class NgxUtilsCalendarDateComponent implements OnInit {
    ...
    constructor(
        ...
        private readonly dialogRef: MatDialogRef<NgxUtilsCalendarDateComponent>,
    ) {}
