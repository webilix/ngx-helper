...
@Component({
    templateUrl: './ngx-utils-calendar-week.component.html',
    styleUrls: ['./ngx-utils-calendar-week.component.scss'],
})
export class NgxUtilsCalendarWeekComponent implements OnInit {
    ...
    constructor(
        ...
        private readonly dialogRef: MatDialogRef<NgxUtilsCalendarWeekComponent>,
    ) {}
